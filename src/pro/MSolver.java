...
class Node {
	...
	JButton genMapB = new JButton("Randomize");
	...
	private void initialize() {	//INITIALIZE THE GUI ELEMENTS
		...
		toolP.setBackground(Color.LIGHT_GRAY);
		toolP.setBounds(10,10,210,600);
		
		searchB.setBounds(40,space, 120, 25);
		searchB.setBorder(new RoundedBorder(30));
	
		toolP.add(searchB);
		space+=buff;
		
		resetB.setBounds(40,space,120,25);
		resetB.setBorder(new RoundedBorder(30));
	
		toolP.add(resetB);
		space+=buff;
		
		genMapB.setBounds(40,space, 120, 25);
		genMapB.setBorder(new RoundedBorder(30));

		toolP.add(genMapB);
		space+=buff;
		
		clearMapB.setBounds(40,space, 120, 25);
		clearMapB.setBorder(new RoundedBorder(30));
